...
# PROJECT PAGES
flowcharts = st.Page("pages/3_Flowcharts.py", title="3. Flowcharts")
airflow = st.Page("pages/4_Airflow.py", title="4. Airflow")
...
appendix = st.Page("pages/9_Appendix.py", title="9. Appendix")
...
pg = st.navigation({
    ...
    "PROJECT": [flowcharts, airflow, fastapi_demo, 
